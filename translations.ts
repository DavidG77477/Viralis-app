export const translations = {
    fr: {
        ...
        downloadPreparing: "Préparation du filigrane…",
        downloadLoadingWatermark: "Chargement du filigrane…",
        downloadCompositing: "Assemblage vidéo + audio…",
        downloadFinalizing: "Finalisation…",
        downloadError: "Impossible de générer la vidéo filigranée. Réessaie.",
        // Errors
    ...
    en: {
        ...
        downloadPreparing: "Preparing watermark…",
        downloadLoadingWatermark: "Loading watermark…",
        downloadCompositing: "Compositing video & audio…",
        downloadFinalizing: "Finalizing…",
        downloadError: "Unable to create the watermarked download. Please try again.",
        // Errors
    ...
    es: {
        ...
        downloadPreparing: "Preparando la marca de agua…",
        downloadLoadingWatermark: "Cargando la marca de agua…",
        downloadCompositing: "Combinando video y audio…",
        downloadFinalizing: "Finalizando…",
        downloadError: "No se pudo generar la descarga con marca. Inténtalo de nuevo.",
        // Errors
